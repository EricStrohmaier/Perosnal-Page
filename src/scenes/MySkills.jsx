...
const MySkills = () => {
  ...
  return (
    <section id="skills" className="pt-2 pb-1 ">
      ...
      <div className={`text-center flex flex-col absolute w-2/3   left-96 top-24 text-2xl ${firstHovered || secondHoverd ? "opacity-0": "opacity-100"}`}>
          <p className="mb-10 font-semibold  text-primary-color">Hover the book shelfs to find out more...</p>
      ...
      >
        <p className="text-primary-color  font-bold  underline underline-offset-2 ">Front-End</p>
    ...
    <div className="flex flex-wrap w-full relative">
      ...
      >
            <p className="text-accent  font-bold  underline underline-offset-2">Back-End</p>
            <p> Node.js</p>
            <p> Express</p>
            <p> MongoDB</p> 
          </div>
